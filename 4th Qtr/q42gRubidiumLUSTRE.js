...
function addMovie() {
    ...
    let existingMovie = movies.find(function(m) {
    ...
    if (existingMovie) {
        ...
        // average the ratings
        let avgRating = Math.round((parseInt(existingMovie.rating) + parseInt(rating)) / 2);

        existingMovie.year = year;
        existingMovie.genre = genre;
        existingMovie.rating = avgRating.toString();
